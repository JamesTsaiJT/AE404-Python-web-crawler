...
LocationSendMessage,VideoSendMessage,AudioSendMessage,ImageSendMessage
...
line_bot_api = LineBotApi('1eMpVJqjF7bg3EiMt6fsJjfNSKbBufaWH')
UserID= 'Ubcb680cd9a534d68f49a56612400f7e1'#'Your_UserID'
...
#多種訊息傳送
message = [text_message,sticker_message,location_message,video_message,image_message]
